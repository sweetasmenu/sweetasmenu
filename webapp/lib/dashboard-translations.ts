...
export const dashboardTranslations = {
  ...
  customer: {
    ...
    pickupWaitTime: { th: 'เวลารออาหารประมาณ 30 นาที หรือน้อยกว่า', en: 'Wait approximately 30 minutes or less', zh: '大约等待30分钟或更短', ja: '約30分以内にお待ちください', ko: '약 30분 이하 대기', vi: 'Chờ khoảng 30 phút hoặc ít hơn', hi: 'लगभग 30 मिनट या उससे कम प्रतीक्षा करें', es: 'Espere aproximadamente 30 minutos o menos', fr: 'Attente d\'environ 30 minutes ou moins', de: 'Wartezeit ca. 30 Minuten oder weniger', id: 'Tunggu sekitar 30 menit atau kurang', ms: 'Tunggu kira-kira 30 minit atau kurang' },
