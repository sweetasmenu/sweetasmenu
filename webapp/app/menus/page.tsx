      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
          ...
          <div className="flex gap-2 sm:gap-3">
            ...
            <Link
              href="/upload"
              className="inline-flex items-center px-3 sm:px-6 py-2 sm:py-3 bg-orange-500 hover:bg-orange-600 text-white rounded-lg font-semibold transition-colors text-sm sm:text-base"
            >
            ...
            {menus.map((menu) => (
              ...
              >
                ...
                <div className="p-4 sm:p-6">
                  {/* Name */}
                  <h3 className="font-bold text-lg sm:text-xl text-gray-900 mb-2 truncate">
                  ...
                  <div className="flex items-center justify-between mb-4">
                    <div className="text-xl sm:text-2xl font-bold text-orange-600">
                      ${menu.price} <span className="text-xs sm:text-sm">NZD</span>
                    </div>
                  ...
                  <div className="flex gap-1.5 sm:gap-2">
                    ...
                    {(userRole === 'enterprise' || userRole === 'premium' || userRole === 'admin') && userRestaurants.length > 1 && (
                      <button
                        ...
                        className="px-2.5 sm:px-4 py-2 bg-green-500 hover:bg-green-600 text-white rounded-lg text-sm font-semibold transition-colors"
                    ...
                    <button
                      ...
                      className="px-2.5 sm:px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg text-sm font-semibold transition-colors"
                    ...
                    <button
                      ...
                      className="px-2.5 sm:px-4 py-2 bg-red-500 hover:bg-red-600 disabled:bg-red-300 disabled:cursor-not-allowed text-white rounded-lg text-sm font-semibold transition-colors"
          ...
          <div className="mt-8 bg-white rounded-xl shadow-md p-4 sm:p-6">
            ...
            <div className="grid grid-cols-3 gap-3 sm:gap-6">
              <div className="text-center">
                <div className="text-2xl sm:text-3xl font-bold text-orange-600">{menus.length}</div>
              ...
              <div className="text-center">
                ...
                <div className="text-xs sm:text-sm text-gray-600">Add-ons</div>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <div className="bg-white rounded-2xl shadow-2xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
            <div className="sticky top-0 bg-white border-b border-gray-200 px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
              <h2 className="text-xl sm:text-2xl font-bold text-gray-900">Edit Menu Item</h2>
              <button
                ...
                {editForm.meats.length > 0 ? (
                  <div className="space-y-2">
                    {editForm.meats.map((meat, idx) => (
                      <div key={idx} className={`flex flex-wrap items-center gap-1.5 sm:gap-2 p-2 rounded-lg ${meat.is_available !== false ? 'bg-gray-50' : 'bg-red-50 border border-red-200'}`}>
                        {/* Availability Toggle */}
                        <button
                          type="button"
                          onClick={() => {
                        ...
                        <input
                          ...
                          placeholder="Name"
                          className={`flex-1 min-w-[80px] px-2 sm:px-3 py-1 border border-gray-300 rounded text-sm text-gray-900 bg-white ${meat.is_available === false ? 'opacity-50' : ''}`}
                        />
                        <div className="flex-1 min-w-[80px] relative">
                          <input
                            ...
                            placeholder={translatingMeatIdx === idx ? "Translating..." : "English"}
                            className={`w-full px-2 sm:px-3 py-1 border border-gray-300 rounded text-sm text-gray-900 bg-white ${translatingMeatIdx === idx ? 'bg-gray-100' : ''} ${meat.is_available === false ? 'opacity-50' : ''}`}
                        ...
                        <input
                          ...
                          placeholder="Price"
                          className={`w-16 sm:w-24 px-2 sm:px-3 py-1 border border-gray-300 rounded text-sm text-gray-900 bg-white ${meat.is_available === false ? 'opacity-50' : ''}`}
                        />
                        <button
                          type="button"
                          onClick={() => {
                ...
                {editForm.addOns.length > 0 ? (
                  <div className="space-y-2">
                    {editForm.addOns.map((addon, idx) => (
                      <div key={idx} className={`flex flex-wrap items-center gap-1.5 sm:gap-2 p-2 rounded-lg ${addon.is_available !== false ? 'bg-gray-50' : 'bg-red-50 border border-red-200'}`}>
                        {/* Availability Toggle */}
                        <button
                          type="button"
                          onClick={() => {
                        ...
                        <input
                          ...
                          placeholder="Name"
                          className={`flex-1 min-w-[80px] px-2 sm:px-3 py-1 border border-gray-300 rounded text-sm text-gray-900 bg-white ${addon.is_available === false ? 'opacity-50' : ''}`}
                        />
                        <div className="flex-1 min-w-[80px] relative">
                          <input
                            type="text"
                            ...
                            placeholder={translatingAddOnIdx === idx ? "Translating..." : "English"}
                            className={`w-full px-2 sm:px-3 py-1 border border-gray-300 rounded text-sm text-gray-900 bg-white ${translatingAddOnIdx === idx ? 'bg-gray-100' : ''} ${addon.is_available === false ? 'opacity-50' : ''}`}
                        ...
                        <input
                          ...
                          placeholder="Price"
                          className={`w-16 sm:w-24 px-2 sm:px-3 py-1 border border-gray-300 rounded text-sm text-gray-900 bg-white ${addon.is_available === false ? 'opacity-50' : ''}`}
                        />
                        <button
                          type="button"
                          onClick={() => {
